...
The FastAPI backend must be running before starting the frontend. See the [backend repo]([<backend-repo-url>](https://github.com/Korser890/shortage-tracker-dashboard)) for setup instructions.
